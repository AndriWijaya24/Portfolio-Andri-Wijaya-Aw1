...
function scrollHeader() {
    ...
    //when the scroll is geater than 80 viewport height, add the scroll-header class to header tag
...
function scrollUp() {
    ...
    //when the scroll is geater than 350 viewport height, add the show-scroll class to scroll-top class
